...
The edited regulation.bin can be a modded one, in which case the status effect will be merged
into it. This mod only edits SpEffectParam. However, it does override speffects 100620 and 100621,
which some mods use to apply other permanent effects.

The final step is to configure Mod Engine 2 to load the regulation.bin. You can do this by
editing config_eldenring.toml so that the first line references the mod directory, as follows
